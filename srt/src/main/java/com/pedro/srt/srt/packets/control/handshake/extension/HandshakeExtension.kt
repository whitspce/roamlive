...
data class HandshakeExtension(
  ...
  /** Stream IDs can contain routing credentials. Never expose them in logs. */
  override fun toString(): String {
    return "HandshakeExtension(version=$version, flags=$flags, receiverDelay=$receiverDelay, " +
        "senderDelay=$senderDelay, path=<redacted>, encrypted=${encryptInfo != null})"
  }
}
