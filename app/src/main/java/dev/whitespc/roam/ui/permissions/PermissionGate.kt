...
fun PermissionGate(
    ...
    // A denied user can grant access from Android settings and return without
    // restarting the app.
    ...
    if (granted) {
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Roam uses your camera and microphone only while " +
                        "you preview or stream.",
                ...
                if (requestAttempted) {
                    ...
                    Text(
                        text = "Permission was not granted. Try again or enable it in Android settings.",
