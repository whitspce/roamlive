...
object NetworkMonitor {
    ...
    /** Edge-triggered signal for an unavailable-to-available transition.
     *  Consumers must also inspect [isAvailable], because this flow deliberately
     *  does not replay old transitions to late collectors. */
        ...
        cm.registerNetworkCallback(request, object : ConnectivityManager.NetworkCallback() {
            override fun onAvailable(network: Network) {
                ...
                synchronized(activeNetworks) {
                    ...
                    networkCount = activeNetworks.size
                }
                Log.d(TAG, "network available ($network) - total: $networkCount")
                if (wasEmpty) {
            ...
            override fun onLost(network: Network) {
                ...
                Log.d(TAG, "network lost ($network) - remaining: $networkCount")
                if (nowEmpty) {
